...
const Speciality = () => {
  return (
    <div className='flex flex-col items-center gap-4 text-gray-800 mt-15' id='#speciality'>
      <h1 className='text-3xl font-medium mt-2 sm:mt-4 md:mt-0'>Find by speciality</h1>
